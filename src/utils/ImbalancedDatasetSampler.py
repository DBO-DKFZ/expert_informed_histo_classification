# source: https://github.com/Schinkikami/PyT-ImbalancedDatasetSampler
import torch
...
class ImbalancedDatasetSampler(Sampler):
	...
	Args:
		 ...
		 num_classes (int): The number of classes in the dataset. If set to None, will automatically be computed from the labels.
	...
	def __init__(self, dataset: Dataset, sampling_factor: Union[str, float] = None, num_classes: Optional[int] = None , shuffle: bool = False, labels: Optional[Union[list, list[list]]] = None,
		...
		#Auto-compute num_classes
		if self.num_classes is None:
			self.num_classes = len(torch.unique(torch.tensor(data=labels, dtype=torch.int)))
